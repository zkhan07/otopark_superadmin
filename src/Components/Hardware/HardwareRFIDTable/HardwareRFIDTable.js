...
const headCells = [
  ...
  {
    id: "rfidReaderLocation",
    numeric: true,
    disablePadding: false,
    label: "RFID Reader Location",
    minWidth: 150
  },
  {
    id: "entryTime",
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.fastagId}</TableCell>
                      <TableCell align="center">{row.fastagStatus}</TableCell>
                      <TableCell align="center">{row.phoneNo}</TableCell>
                      <TableCell align="center">{row.name}</TableCell>

                      <TableCell align="center">
                        {row.rfidReaderLocation}
                      </TableCell>
                      ...
                      <TableCell align="center">{row.parkingFree}</TableCell>
